    ...
    public function run(): void
    {
        DB::table('users')->insert([
            [
                ...
                'is_verified'   => true,
                'national_id'   => '11111111111111', // أضف رقم البطاقة
                'created_at'    => now(),
                'updated_at'    => now(),
            ],
            [
                ...
                'is_verified'   => true,
                'national_id'   => '22222222222222', // أضف رقم البطاقة
                'created_at'    => now(),
                'updated_at'    => now(),
            ],
            [
                ...
                'is_verified'   => true,
                'national_id'   => '33333333333333', // أضف رقم البطاقة
                'created_at'    => now(),
                'updated_at'    => now(),
            ],
            [
                ...
                'is_verified'   => true,
                'national_id'   => '44444444444444', // أضف رقم البطاقة
                'created_at'    => now(),
                'updated_at'    => now(),
            ],
        ]);
